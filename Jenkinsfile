    ...
    stages {
        stage('Build') {
            steps {
                ...
                // sh 'go build -ldflags="-s -w" -buildmode c-shared -o .build/uplink.so storj.io/uplink-c'
                ...
                stage('Testsuite') {
                    ...
                    post {
                        always {
                            ...
                            junit 'build/test-results/testReleaseUnitTest/TEST-io.storj.UplinkTest.xml'
                        }
                    }
                }
            }
